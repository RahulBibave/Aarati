...
import com.rahul.aarati.jna.HCNetSDKJNAInstance;
import com.rahul.aarati.jna.JNATest;
import com.rahul.aarati.utils.CrashUtil;
import com.rahul.aarati.widget.PlaySurfaceView;


public class MainActivity extends Activity implements SurfaceHolder.Callback {
    private static final String TAG = "MainActivity";

    private static final String IP_ADDRESS = "58.84.14.57";
    //private static final String IP_ADDRESS = "120.138.126.77";
   ...
   // private static final String PASSWORD = "Admin@12345";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button=findViewById(R.id.buExit);
    ...
    private int loginNormalDevice() {
        ...
        if (netDvrDeviceInfoV30.byChanNum > 0) {
            ...
            chanNum = netDvrDeviceInfoV30.byIPChanNum + netDvrDeviceInfoV30.byHighDChanNum * 128;
        }
    ...
    private void ChangeSingleSurFace(boolean bSingle) {
        ...
        if (bSingle) {
            ...
            playView[0].setParam(metric.widthPixels * 4);
            FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(
                    FrameLayout.LayoutParams.WRAP_CONTENT,
                    FrameLayout.LayoutParams.WRAP_CONTENT);
